...
from .object_map_new import markers
...
class BaseBrowser:
    ...
    def __init__(
        ...
        self.url = url
        self.uname_var = "m11kk4@windowslive.com" or os.environ.get("USERNAME_VAR")
        self.pwd_var = "tvJ6wA1d8TW4kx6jJ3q4" or os.environ.get("PASSWORD_VAR")
...
#MAIL = "m11kk4@windowslive.com"
#PASSWORD = "tvJ6wA1d8TW4kx6jJ3q4"

            username = "m11kk4@windowslive.com" or os.environ.get(self.uname_var)
            password = "tvJ6wA1d8TW4kx6jJ3q4" or os.environ.get(self.pwd_var)
